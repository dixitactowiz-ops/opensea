...
#         "top_offer": get_value(
#             item, "bestOffer", "pricePerItem", "token", "unit"
#         ),
#         "top_offer_currency": get_value(
#             item, "bestOffer", "pricePerItem", "token", "symbol"
#         ),
#         "top_offer_usd": get_value(item, "bestOffer", "pricePerItem", "usd"),
#         "collection_floor": get_value(
#             item, "collection", "floorPrice", "pricePerItem", "token", "unit"
#         ),
#         "collection_floor_currency": get_value(
#             item, "collection", "floorPrice", "pricePerItem", "token", "symbol"
#         ),
#         "collection_floor_usd": get_value(
#             item, "collection", "floorPrice", "pricePerItem", "usd"
#         ),
...
#         ),
#         "buy_currency": get_value(
#             item, "bestListing", "pricePerItem", "token", "symbol"
#         ),
...
#     urls_to_scrape = read_product_urls()
#     print(f"Found {len(urls_to_scrape)} URLs to process.")

#     MAX_WORKERS = 30

#     with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
#         executor.map(process_url, urls_to_scrape[:1])
